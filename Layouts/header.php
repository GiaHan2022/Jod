        ...
        <div class="container-header">
            <div class="row">
                <div class="col-4">
                    <div class="row my-3">
                        <div class="col-3">
                            <a href="./index.php"> <img style="width: 30px; height: 30px;" src="./images/logof8.png"
                                    alt=""></a>
                        </div>
                        <div class="col-9">
                            <h3>Học lập trình đi làm</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 ">
                    <div class="row justify-content-end my-3">
                        ...
                        <?php } else{?>
                        <div class="col-5 ">
                            <li class="dangnhap2"><a href="index.php?action=dangki">Đăng kí</a></li>
                        </div>
                        <div class="col-5 ">
                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="2000">
                                <img style="width: 100%; height: 300px; border-radius: 30px;"
                                    src="./images/bannerf8.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img style="width: 100%; height: 300px; border-radius: 30px;"
                                    src="./images/Bannerf82.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img style="width: 100%; height: 300px; border-radius: 30px;"
                                    src="./images/bannerf83.png" class="d-block w-100" alt="...">
                            </div>
                        </div>
